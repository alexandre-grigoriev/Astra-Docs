...
# Andor Spectrometer Module Configuration

This chapter specifies configuration settings of the `astra-QtAndor` module.

## Andor module settings

Module settings in the modules/andor group.

| Key         | Description        | Default Value                 |
|-------------|--------------------|-------------------------------|
| **verbose** | Verbose log output | false (Release), true (Debug) |
